...
ggplot(df_enlaces_dedup, aes(x = n, fill = is_absolute)) + geom_histogram(alpha = 0.6, position = "dodge", bins = 10) + scale_fill_manual(values = c("TRUE" = "blue", "FALSE" = "red")) + theme_minimal()
